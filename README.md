<div align="center">
  ...
  <p>금융 분야에서 데이터 분석의 중요성이 날로 커지고 있는 만큼, 데이터의 정확한 분석과 인사이트 도출이 핵심이라는 것을 깊이 이해하고 있습니다. </p>
  ...
  <p>저의 학습 여정과 실습 결과물을 통해 데이터 분석의 기법과 노하우를 공유하고, 더 나아가 금융 분야에서의 데이터 분석 역량을 더욱 강화해 나가겠습니다. </p>
