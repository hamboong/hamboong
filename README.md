<div align="center">
  ...
  <h2>안녕하세요, 강현주입니다😊</h2>
  <p>저는 금융권 데이터 분석 직렬 취업을 목표로 하고 있습니다.</p>
  <p>금융 분야에서 데이터 분석의 중요성이 날로 커지고 있는 만큼,</p> 
  <p> 데이터의 정확한 분석과 인사이트 도출이 핵심이라는 것을 깊이 이해하고 있습니다. </p>
  <p>이를 위해 관련 지식과 기술을 체계적으로 학습하고 있으며, 실제 업무에 적용할 수 있는 실력을 쌓아가고 있습니다.</p>
  </p>  </p>
  <p>📊** Data Analyst가 되기 위한 과정과 프로젝트들**을 제 깃허브에 정리하고 공유하고자 합니다.</p> 
  <p>저의 학습 여정과 실습 결과물을 통해 데이터 분석의 기법과 노하우를 공유하고,</p> 
  <p> 더 나아가 금융 분야에서의 데이터 분석 역량을 더욱 강화해 나가겠습니다. </p>
  <p>🚀함께 제 성장 과정을 지켜봐 주시고, 많은 피드백과 조언을 부탁드립니다!</p>
</div>
